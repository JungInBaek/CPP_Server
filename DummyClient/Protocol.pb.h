...
class S_TEST final :
 ...
 public:
  ...
  void clear_att();
  uint32_t att() const;
  void set_att(uint32_t value);
  private:
  uint32_t _internal_att() const;
  void _internal_set_att(uint32_t value);
  public:
...
inline void C_MOVE::clear_pos() {
  _impl_.pos_ = uint64_t{0u};
}
inline uint64_t C_MOVE::_internal_pos() const {
  return _impl_.pos_;
}
inline uint64_t C_MOVE::pos() const {
  // @@protoc_insertion_point(field_get:Protocol.C_MOVE.pos)
  return _internal_pos();
}
inline void C_MOVE::_internal_set_pos(uint64_t value) {
  
  _impl_.pos_ = value;
}
inline void C_MOVE::set_pos(uint64_t value) {
...
// uint32 att = 3;
inline void S_TEST::clear_att() {
  _impl_.att_ = 0u;
}
inline uint32_t S_TEST::_internal_att() const {
  return _impl_.att_;
}
inline uint32_t S_TEST::att() const {
  // @@protoc_insertion_point(field_get:Protocol.S_TEST.att)
  return _internal_att();
}
inline void S_TEST::_internal_set_att(uint32_t value) {
  
  _impl_.att_ = value;
}
inline void S_TEST::set_att(uint32_t value) {
  _internal_set_att(value);
  // @@protoc_insertion_point(field_set:Protocol.S_TEST.att)
}
