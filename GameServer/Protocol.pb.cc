...
PROTOBUF_CONSTEXPR C_MOVE::C_MOVE(
    ::_pbi::ConstantInitialized): _impl_{
    /*decltype(_impl_.id_)*/uint64_t{0u}
  , /*decltype(_impl_.pos_)*/uint64_t{0u}
  , /*decltype(_impl_._cached_size_)*/{}} {}
...
const uint32_t TableStruct_Protocol_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::Protocol::S_TEST, _impl_.att_),
...
const char descriptor_table_protodef_Protocol_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "MOVE\022\n\n\002id\030\001 \001(\004\022\013\n\003pos\030\002 \001(\004\"P\n\006S_TEST\022"
  "\n\n\002id\030\001 \001(\004\022\n\n\002hp\030\002 \001(\r\022\013\n\003att\030\003 \001(\r\022!\n\005"
  "buffs\030\004 \003(\0132\022.Protocol.BuffData\"\t\n\007S_LOG"
  "INb\006proto3"
  ;
...
const ::_pbi::DescriptorTable descriptor_table_Protocol_2eproto = {
    false, false, 210, descriptor_table_protodef_Protocol_2eproto,
    "Protocol.proto",
...
uint8_t* C_MOVE::_InternalSerialize(
  ...
  if (this->_internal_pos() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteUInt64ToArray(2, this->_internal_pos(), target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:Protocol.C_MOVE)
  ...
  // uint64 pos = 2;
  if (this->_internal_pos() != 0) {
    total_size += ::_pbi::WireFormatLite::UInt64SizePlusOne(this->_internal_pos());
  }
...
S_TEST::S_TEST(const S_TEST& from)
  ...
  new (&_impl_) Impl_{
    ...
    , decltype(_impl_.id_){}
    , decltype(_impl_.hp_){}
    , decltype(_impl_.att_){}
    , /*decltype(_impl_._cached_size_)*/{}};

  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  ::memcpy(&_impl_.id_, &from._impl_.id_,
    static_cast<size_t>(reinterpret_cast<char*>(&_impl_.att_) -
    reinterpret_cast<char*>(&_impl_.id_)) + sizeof(_impl_.att_));
    ...
    switch (tag >> 3) {
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 24)) {
          _impl_.att_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* S_TEST::_InternalSerialize(
  ...
  if (this->_internal_att() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteUInt32ToArray(3, this->_internal_att(), target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:Protocol.S_TEST)
  ...
  // uint32 att = 3;
  if (this->_internal_att() != 0) {
    total_size += ::_pbi::WireFormatLite::UInt32SizePlusOne(this->_internal_att());
  }
...
void S_TEST::InternalSwap(S_TEST* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(S_TEST, _impl_.att_)
      + sizeof(S_TEST::_impl_.att_)
